...
export const Inspector = ({
  ...
  function paramUpdated (param, attr, value, paramType) {
    const newDefinition = { ...component.component.definition };

    const allParams = newDefinition[paramType] || {};
  ...
  function eventOptionUpdated (event, option, value) {
    ...
    const newDefinition = { ...component.component.definition };
    const eventDefinition = newDefinition.events[event.name] || { options: {} };
