...
export const EventManager = ({
  ...
  const possibleEvents = Object.keys(componentMeta.events).filter(eventId => !excludeEvents.includes(eventId)).map(eventId => {
    return {
  ...
  function handlerChanged (index, param, value) {
    const newEvents = component.component.definition.events;
